...
export default function Categories ( props ) {
	...
	const { productChantarelleProf,  heroCarousel } = props;
	...
	return (
		<Layout>
			...
			<div className="categories product-categories-container container mx-auto my-32  xl:px-0">
				<h2 className="text-2xl mb-5 uppercase">СHANTARELLE Prof</h2>
				<ParentCategoriesBlock productChantarelleProf={ productChantarelleProf }/>
