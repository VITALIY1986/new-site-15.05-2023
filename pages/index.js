				...
				<div className="flex justify-center items-center flex-col lg:flex-row">
					<div className="w-full lg:w-6/12 m-3  relative ">
						...
						<div><strong>	Приєднуйтеся за посиланям нижче:</strong></div>
							<a href=" https://invite.viber.com/?g=Jzq36PUtHFBHc7yo6PwO9LwZE1xOid_3"><button className="button  text-white px-5 py-5 mt-10 rounded-full w-full ">Приєднатися</button></a>
					</div>
