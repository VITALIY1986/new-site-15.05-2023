...
<p className="mt-3">Крім цього, лінійка товару включає і постільна білизна для готелів. Незалежно від того, який вас цікавить товар, ми впевнені, що вам припаде до душі і якість виробів, їх вартість та їх вибір.</p>
...
<li> - Ми гарантуємо оперативну, своєчасну доставку товару за вказаною адресою.• У нас працюють досвідчені та кваліфіковані консультанти, здатні допомогти з вибором і відповісти на всі запитання клієнта.</li>
...
<p className="mt-6">Різноманітність творчих дизайнів, приголомшливі вироби відмінної якості, виготовлені з кращих матеріалів за сучасними технологіями, акуратне пошиття – все це вигідно відрізняє постільну білизну та інше приладдя магазину LUXTEX від інших магазинів.</p>
                                                    </div>
				</div>
				</div>
