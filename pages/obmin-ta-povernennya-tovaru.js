...
<p className="mt-3">Ми не зможемо прийняти повернення товару після прання, навіть якщо він не використовувався. Виріб має бути невикористанимі незіпсованим, а комплектація та оригінальне пакування мають бути збережені. Якщо повернення товару здійснюється через поштові служби, доставку необхідно оплатити самостійно.</p>
...
<h2 className="text-xl mt-3">Відмова від товару, обмін і повернення товару</h2>
